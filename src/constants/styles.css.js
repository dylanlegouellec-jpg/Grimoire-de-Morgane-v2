...
.illus-photo-frame { background: var(--parchment); }
.illus-photo {
  display: block; width: 100%; height: 100%; object-fit: cover;
  -webkit-touch-callout: none; /* bloque le menu iOS (Copier / Enregistrer) sur appui long */
  -webkit-user-select: none; user-select: none;
  pointer-events: none; /* laisse l'appui long atteindre le <div> parent (RecipeCard) */
}
.fav-btn {
